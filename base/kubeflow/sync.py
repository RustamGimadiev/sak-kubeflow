...
def get_settings_from_env(controller_port=None,
                          ...
                          minio_access_key=None, minio_secret_key=None, kfp_default_pipeline_root=None, bucket_name=None):
    """
    ...
    settings["kfp_default_pipeline_root"] = \
        ...
        os.environ.get("KFP_DEFAULT_PIPELINE_ROOT") or \
        "minio://" + os.environ.get("BUCKET_NAME") + "/v2/artifacts"
...
def server_factory(visualization_server_image,
                   ...
                   url="", controller_port=8080, bucket_name=None):
    """
